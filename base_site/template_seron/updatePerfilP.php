    ...
    <div class="table-responsive">
        <table class="table table-sm table-bordered table-hover">
            ...
            <tbody>
                    ...
                    <tr>
                        <?php $part = $participante->getParticipante($session_id); ?>
                    ...
                    <!-- Modal -->
                    <div class="modal fade" id="editar<?= $part->getId() ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                ...
                                <div class="modal-body">
                                    <form action="updateParticipante.php" method="POST">
                                        <div class="row">
                                            <div class="col-md-5">
                                                <label>Nome</label>
                                                <input type="text" name="name" value="<?= $part->getNome() ?>" class="form-control" required />
                                            </div>
                                            <div class="col-md-7">
                                                <label>E-mail</label>
                                                <input type="email" name="email" value="<?= $part->getEmail() ?>" class="form-control" required />
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-3">
